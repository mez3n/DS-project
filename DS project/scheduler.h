...
class scheduler :public Stream {
	...
	LinkedList<Process*> TRM_LIST; // The terminated list can be implemented using queue The processes that have completed their execution can be added to the end of the queue
