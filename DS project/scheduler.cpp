...
void scheduler::simulate_system()
{
	...
	Process* p;
	Process* p1;// temporary pointer to move from blk to rdy
	Process* p2;// temporary pointer to a process from rdy list
	Process* Run_P;// pointer to get the run process in a processor
